...
// all color test, red, blue, green, cyan, orange, violete, white	  	
const int16 test_color[10][3] =
{
	{0x0000, 0x07FF, 0x0000},
	{0x0000, 0x0000, 0x07FF},
	{0x03FF, 0x0000, 0x0000},
	{0x0000, 0x03FF, 0x03FF},
	{0x01FF, 0x0000, 0x01FF},
...
//!		rgb_bits.blue = test_color[tc][0];
//!		rgb_bits.red = test_color[tc][1];
//!		rgb_bits.green = test_color[tc][2];
//!		if (tc > 8) tc = 0;
//!		else tc++;
